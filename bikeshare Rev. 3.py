# Rev.3: Display function is added.
...
def viewdata(dfrm):
    end_of_rows = 5
    while True: 
        checkviewdata = input ('Would you like to view 5 rows of data [y,n]? ')
        if checkviewdata =='y':
            print (dfrm.iloc[end_of_rows-5:end_of_rows])
            end_of_rows = end_of_rows + 5
        elif checkviewdata =='n':
            break
        else:
